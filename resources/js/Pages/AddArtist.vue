                                ...
                                <div>
                                    <div class="mt-2 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                        <div class="sm:col-span-3">
                                            <label for="first-name" class="block text-sm font-medium text-gray-700">Artist Name</label>
                                            <div class="mt-1">
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="spotify_id" id="spotify_id" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                            </div>
                                        </div>
                                        ...
                                        <div class="sm:col-span-6">
                                            ...
                                            <div class="mt-1">
                                                <textarea type="text" name="bio" id="bio" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" rows="5"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    export default {
        ...
        methods: {
            submit() {
                // TODO: Provide your implementation here for creating an artist
            }
        }
    }
</script>
